...
export function EmailCheckPage () {
  ...
  return (
    <div className="page">
      <Header textAlign="center" as='h2'>感謝您費時填寫表單</Header>
      <Segment attached>
  您已經完成表單，研究團隊已經寄了一封信箱驗證信至{email}，請您點擊內附的連結。如果沒有找到該信，請檢視垃圾信件槽。
      </Segment>
    </div>
  )
}
...
export function RepeatPage () {
  return (
    <div className="page">
      <Header textAlign="center" as='h2'>感謝您費時填寫表單</Header>
      <Segment attached>
      您過去已通過信箱驗證或已被納入參與者，表單內容將以過去填寫的為準，如果需要進行修改，請聯絡研究團隊。<br/>
      Email: notiatmuilab@gmail.com
      </Segment>
    </div>
  )
}
